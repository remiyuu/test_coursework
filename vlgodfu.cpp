...
__declspec(naked) char func(signed char* a, signed char* b, signed char* c, signed char* d, signed char* e, signed char* y);
__declspec(naked) int ascbin(char* str, signed char* result);
__declspec(naked) char* binasc(signed char num, char* result);
